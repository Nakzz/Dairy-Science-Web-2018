...
<!--FEATURES--><section class="features text-center" id="features">
    <div class="row">
        <!-- /grid-gallery -->
            ...
            <div class="row">
                <div class="paddingtopsmall">
                    <div class="wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="col-xl-3 col-lg-md-3 contact-details">
                            <div class="col-xl-12 col-lg-12 col-md-12 wow animated fadeInDown" data-wow-duration="1s"
                            data-wow-delay="0.5s">
                                <div class="light-box box-hover">
                                    <p>282 Animal Sciences,
                                        <br>1675 Observatory Dr.
                            ...
                            data-wow-delay="0.7s">
                                <div class="light-box box-hover">
                                    <p style="color:white">Phone: (608) 265-8506
                                        <br>E-mail: <a style="color: white;" href="mailto:name@email.com">vcabrera@wisc.edu</a>
                                        <br>	<a style="color: white;" href="/apps/filemanager/uploads/CV_Cabrera.pdf"
                                        target="_blank">Curriculum Vitae</a>
                                    </p>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-4">	<a id="get_directions" class="learn-more-btn btn-effect" href="https://www.google.com/maps/dir/&apos;&apos;/Animal+Science,+Elm+Dr,+Madison,+WI+53706/data=!4m5!4m4!1m0!1m2!1m1!1s0x8807acc078fbc397:0xb7e3ed786867978f?sa=X&amp;ved=0ahUKEwj_lY_i0qXaAhXE5YMKHUmAAHEQiBMINTAA"
                                target="_blank"><i class="fas fa-map-marker-alt"></i><span>Get Directions</span></a>
                            </div>
                        </div>
                                    ...
                                    <div class="team-member-holder">
                                        <div style="margin-left:54px" class="">
                                            <div class="team-member-image mx-auto">
                                                <img class="mx-auto" alt="" src="assets/img/team/crop_victor.jpg">
                                                <div class="LINKoverlay">
                                                    <div style="padding-top:100%" class="light-box box-hover linksOnly">	<a href="https://www.facebook.com/pages/University-of-Wisconsin-Dairy-Management/172972072340"
                                                        target="_blank" class="blackIcon facebook team-member-links-item"><i class="fab fa-facebook fa-2x"></i></a>
                                                        <a
                                                        href="https://twitter.com/vecabrera" target="_blank" class="twitter team-member-links-item"><i class="blackIcon fab fa-twitter fa-2x"></i>
                                                            </a>	<a href="https://plus.google.com/u/0/112288846247174607175/about" target="_blank"
                                                            class="blackIcon google-plus team-member-links-item"><i class="fab fa-google-plus fa-2x"></i></a>
                                                            <a
                                                            href="http://www.linkedin.com/pub/victor-cabrera/12/3a1/924" target="_blank"
                                                            class="blackIcon twitter team-member-links-item"><i class="fab fa-linkedin fa-2x"></i>
                                                                </a>	<a href="http://www.youtube.com/user/dairybynature/videos" target="_blank"
                                                                class=" blackIcon youtube team-member-links-item"><i class="fab fa-youtube fa-2x"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-xl-4 paddingtopsmall paddingSmall_bottom">	<a class="twitter-timeline" height="300" href="https://twitter.com/vecabrera"
                            data-widget-id="343590479574757376">Tweets by @vecabrerai</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--row ends here-->
			...
			<section class="text-center section-padding" id="responsive">
				...
				<div class="FeaturedImage container-schedule container-fluid wow animated fadeInDown animated" data-wow-duration="1s" data-wow-delay="1s">
