...
<head>
  ...
  <title>Dairy Management Publications</title>
  ...
  $(function() {
      ...
      if (result==true) {
        ...
        if(dataVal >0)
        {
          $.ajax({
            type: "POST",
            url: "process.php",
            data: { del_pub_content_id: dataVal},
    ...
    /*
    <div class="row topmargin5 new_link">
    <div class="col-md-4"><input type="text"   name="link_name['+val+'][]" class="form-control" value="">
    </div>
    <div class="col-md-2 fileUploadDiv">
    <span class="label label-primary">Upload</span>
    <input class="fileUploadBtn" type="file"   name="link_file['+val+'][]" >
    </div>
    <div class="col-md-6 nopadding"><div class="col-md-9 nopadding">
    <input type="text" name="link_url['+val+'][]" class="form-control" placeholder="Or Enter URL" style="width:100%;margin-left:5px;" />
    </div>
    <div class="col-md-3"><span class="glyphicon glyphicon-remove-circle delete_link" style="cursor:pointer"></span>
    </div>
    </div>
    </div>
  */
...
<body>
  ...
  include('classes/class.publication.php');

  $obj = new publication_class;
        ...
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            <form class="bs-example bs-example-form" role="form" name="frmAdd" id="frmAdd" method="post" enctype="multipart/form-data">
              ...
              <div class="col-md-8">
                <h3 class="top_bottom_margin"><span class="label label-default">Title  <span class="small_title">( You can write html here )</span></span></h3>
              </div>
              <div class="col-md-4">
            ...
            <ul id="sortable" class="sortable">
              <?php
              $catDir = DB::queryFirstField("SELECT store_folder FROM pub_categories WHERE id=%s", $catId);

              if(isset($catDir) && $catDir!='')
              {
                $catDir = $catDir.'/';
              }
              ...
              $categor_data = DB::query("SELECT * FROM pub_category_contents WHERE category_id=%s  ORDER BY pub_category_contents.order asc ", $catId);
              ...
              foreach($categor_data as $key => $val){
                ...
                <li class="ui-state-default" id="<?php echo $val['id'];?>" ><span class="ui-icon ui-icon-arrowthick-2-n-s" ></span>
                  ...
                  <div class="col-md-7">
                    <textarea class="form-control" name="titles[<?php echo $m; ?>]" ><?php echo $val['title'];?></textarea>
                  </div>
                  <div class="col-md-4 nopadding" id="section_<?php echo $m; ?>" >
...

                    {
                      if($n_val['type']=='file')
                      {
                        $link_url = SITE_URL.'publications/'.$n_val['filename'];
                      }
