...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 var row_added = 0;
  $(function() {
	...
	<!--Remove the link title-->
	$('body').on('click', '.remove_link_title', function() {		
        ...
        <div class="panel-body">
		   ...
		   ?>
              ...
              ( <a target="_blank" href="<?php echo $link_url; ?>"><?php echo $val['link_title']; ?> </a> ) &nbsp;
                    <span class="glyphicon glyphicon-remove-circle remove_link_title" style="cursor:pointer;position:relative;" data-value="<?php echo $val['id']; ?>"></span>
                    <?php } } else{?>
                    ...
                    <div class="col-md-5 nopadding ">
                        ...
                        <div class="col-md-8">
                        <input type="text" name="link_url[]" id="link_url" class="form-control" placeholder="Enter the  URL" style="width:100%;margin-left:5px;" />
                      </div>
                    </div>
                    <?php } ?>
                  </div>
