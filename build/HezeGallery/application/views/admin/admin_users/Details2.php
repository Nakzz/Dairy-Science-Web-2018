	...
	*/
	...
	<a href="<?php echo H_ADMIN;?>&view=admin_exempt&userid=<?php echo UserID();?>&do=update" title="<?php echo LANG_TIP_UPDATE;?> Record" class="btn btn-default btn-sm tip"><i class="fa fa-edit"></i> <?php echo LANG_UPDATE;?></a>
    
    <a href="<?php echo H_ADMIN;?>&view=admin_exempt&userid=<?php echo UserID();?>&do=updatepwd" title="<?php echo LANG_TIP_UPDATE;?> Record" class="btn btn-default btn-sm tip"><i class="fa fa-lock"></i> Change Password</a>
  ...
  <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-reorder"></i> <strong>Profile Details</strong> </h3></div>
