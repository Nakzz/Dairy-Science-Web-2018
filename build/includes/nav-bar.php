<div id="navDim" class="header header-hide dimmedNav">
<div class="container ">
  <div class="row">
...
<!-- <?php // TODO: Make logo bigger in larger screen. do it how ever ?>
     ...
     <div id="navMenuDiv" class="col-lg-9 col-md-9 col-sm-12">
...
<div id="main-nav" class="stellarnav">
  <ul>
    ...
    <li><a href="projects.php">Projects</a>
          <ul>
            <li><a href="projects.php#active">Active Projects</a></li>
            <li><a href="projects.php#completed">Completed Projects</a></li>
          </ul>
    </li>
