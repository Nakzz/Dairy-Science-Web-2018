      ...
      <div class="col-sm-12">
						...
						<ul class="slides">
							<li>
								...
								<div class="col-md-4 col-sm-4  wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
									<div class="overlay-effect effects clearfix">
										<div class="img">
											<img src="assets/img/team/blank.gif" data-echo="assets/img/team/Lilian.jpg" alt="Portfolio Item">
											<div class="overlay">
												<button class="md-trigger expand" data-modal="modal-liliana"><i class="big-icon fa fa-search"></i><br>View More</button>
											</div>
										</div>
									</div>
									<h4 class="text-center">Liliana Fadul</h4>
								</div>
			...
			<!-- Card Info -->
				...
				<!-- /Card Info -->
								...
								<!-- Card Info -->
				<div class="md-modal md-effect-9" id="modal-liliana">
					<div class="md-content">
						<div class="folio">
							<div class="avatar28"></div>
							<div class="sp-name"><strong>Liliana Fadul</strong><br/>Postdoc, UW2020 virtual dairy farm brain project</div>
							<div class="sp-dsc">
								Liliana Fadul got her Bachelor’s degree in Animal Science from Universidad de La Salle in Bogota Colombia. 
								Then she obtained her MS degree in Agricultural Science and Natural Resources from Universidad Autónoma del Estado 
								de Mexico (UAEM) – ICAR in Toluca, Mexico. To continue with her studies, she moved to Quebec City (Canada) were she 
								completed her PhD in Animal Science from Université Laval. After her pleasant experience working with the Valacta (DHIA 
								from Quebec and the Atlantics) database during her PhD, she obtained a MITACS Elevate award (postdoctoral fellowship) 
								to worked with Valacta on data valorization generated by automatic milking systems. Currently, Liliana is working as Research
								 Associate (Postdoc) at Dr. Cabrera’s lab as part of the UW2020 virtual dairy farm brain project.
								<!-- <blockquote>
								<p>Here is a long quotation here is a long quotation proin gravida nibh vel velit auctor aliquet aenean sollicitudin.</p>
							</blockquote> -->
						</div>
    ...
    <div class="row"> <!--Row-->
      <div class="col-sm-12">
						...
						<ul class="slides">
							<li>
								...
								<div class="col-md-4 col-sm-4 wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="0.7s">
									<div class="overlay-effect effects clearfix">
										<div class="img">
											<img src="assets/img/team/blank.gif" data-echo="assets/img/team/WenLi.jpg" alt="Portfolio Item">
											<div class="overlay">
												<button class="md-trigger expand" data-modal="modal-Wen"><i class="big-icon fa fa-search"></i><br>View More</button>
											</div>
										</div>
									</div>
									<h4 class="text-center">Wen Li</h4>
								</div>
		...
		<!-- /Card Info -->
				...
				<!-- Card Info -->
		<div class="md-modal md-effect-9" id="modal-Wen">
			<div class="md-content">
				<div class="folio">
					<div class="avatar29"></div>
					<div class="sp-name"><strong>Wen Li</strong><br/>M.S. Student</div>
					<div class="sp-dsc">
						Wen is from China and had his BS degree in Northwest A&F University in Animal Science focusing on 
						dairy nutrition. He followed his father, a dairy manager and consultant, to learn farm management. 
						He started his Master program under the guidance of Dr. Cabrera at University of Wisconsin- Madison 
						in 2018 Fall.
						<!-- <blockquote>
							<p>Idea: Maybe timeline or something?</p>
						</blockquote> -->
