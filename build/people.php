...
<?php // TODO: resize all images to same height and width ?>
<!--SPEAKERS-->
...
<div class="container paddingtop">
	<div class="row">
		<div class="col-lg-8 wow animated fadeInUp align-center" data-wow-duration="1s" data-wow-delay="1s">
			<h1 class="arrow">Ph.D. Students</h1><hr>
		</div>
	</div>
	<div class="row">
		<div class="speakers-wrap">
...
<div class="container paddingtop">
	<div class="row">
		<div class="col-lg-8 wow animated fadeInUp align-center" data-wow-duration="1s" data-wow-delay="1s">
			<h1 class="arrow">M.S. Students</h1><hr>
		</div>
	</div>
	<div class="row">
		<div class="speakers-wrap">
...
<div class="container paddingtop">
	<div class="row">
		<div class="col-lg-8 wow animated fadeInUp align-center" data-wow-duration="1s" data-wow-delay="1s">
			<h1 class="arrow">Sabbatical Researcher</h1><hr>
		</div>
	</div>
	<div class="row">
		<div class="speakers-wrap">
...
<div class="container paddingtop">
	<div class="row">
		<div class="col-lg-8 wow animated fadeInUp align-center" data-wow-duration="1s" data-wow-delay="1s">
			<h1 class="arrow">Outreach Specialists</h1><hr>
		</div>
	</div>
	<div class="row">
		<div class="speakers-wrap">
				...
				<ul class="slides">
					<li>
						...
						<div class="col-md-4 col-sm-4 col-md-offset-2 wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
							...
							<h2>Francisco E. Contreras-Govea</h2>
						</div>
...
<div class="container paddingtop">
	<div class="row">
		<div class="col-lg-8 wow animated fadeInUp align-center" data-wow-duration="1s" data-wow-delay="1s">
			<h1 class="arrow">Project Assistants</h1><hr>
		</div>
	</div>
	<div class="row">
		<div class="speakers-wrap">
